          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
              {ingredients.map((ing, idx) => {
                ...
                const imageUrl = ingredientName
                  ? `https://www.themealdb.com/images/ingredients/${encodeURIComponent(ingredientName)}-small.png`
                  : null;
              ...
              <div>
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <iframe
                    width="100%"
                    height="315"
                    src={`https://www.youtube.com/embed/${getYouTubeVideoId(recipe.strYoutube)}`}
